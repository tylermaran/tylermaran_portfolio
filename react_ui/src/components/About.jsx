...
const About = (props) => {
    ...
    return (
        <div className='about'>
            ...
            <p>I am the Treasurer of <a className="about_link" href="http://www.noisebridge.net" target="new">NoiseBridge Hackerspace</a>, a 501(c)(3) non profit facility that provides tools, equipment, and classes on everything from Network Security to Sewing</p>
        </div>
    );
